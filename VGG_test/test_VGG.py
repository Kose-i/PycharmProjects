...
import os
#str_tmp = os.path.abspath('weights_SSD300.hdf5')
#model.load_weights(str_tmp, by_name=True)
#
...
callbacks = [learnRateSchedule] #weights_save,
...
if not data_augmentation:
    ...
    model.fit_generator(datagen.flow(x_train, y_train,batch_size=batch_size), steps_per_epoch=None, epochs=epochs, verbose=1, callbacks=callbacks, validation_data=(x_test, y_test), validation_steps=None, class_weight=None, max_queue_size=10, workers=1, use_multiprocessing=False, shuffle=True, initial_epoch=0)
